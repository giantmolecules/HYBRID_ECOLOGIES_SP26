...
// OSC configuration
const char* osc_host = "255.255.255.255";  // Broadcast (or set to specific IP)
const int osc_port = 8000;

// Sampling configuration
int sampleRate = 50;  // Samples per second
